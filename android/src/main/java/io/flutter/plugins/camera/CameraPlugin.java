...
public class CameraPlugin implements FlutterPlugin, ActivityAware {
  ...
  public void maybeStartListening(
      Activity activity,
    ...
    methodCallHandler = new MethodCallHandlerImpl(activity, messenger, new CameraPermissions(), permissionsRegistry, textureRegistry);
  }
}
